...
async function main() {
  ...
  const calls = [
    ...
    ['POST', '/api/auth/register', { categoria: 'OUVINTE', name: 'Tmp User', username: 'tmp_user', password: 'password123', inviteCode: 'XD-AAAA-BBBB', newsletterOptIn: false }],
    ...
    ['POST', '/api/waitlist', { email: 'test+1@xdouglas.com', consent: true }],
    ['POST', '/api/waitlist', { email: 'test+2@xdouglas.com', consent: true }],
